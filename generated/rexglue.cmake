...
# Codegen target - run 'cmake --build . --target adfus_codegen'
add_custom_target(adfus_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/adfus_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for adfus"
    VERBATIM
)
